...
func NewApp() (app *cli.App) {
	...
	for _, f := range []string{"cheap", "block-read-cache", "block-read-cache-size", "block-read-cache-mem-ratio", "no-implicit-dir", "stat-cache-ttl", "type-cache-ttl", "http-timeout"} {
