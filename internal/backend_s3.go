...
func createRequest(host string, method string, filePath string, body io.ReadSeeker) *http.Request {
	...
	// if method == "PUT" {
	// 	//req.Header.Add("Content-Length", "5") // placeholder EDIT
	// 	//req.Header.Add("Content-Md5", getMD5Hash(body)) // placeholder EDIT is this necessary
...
func hashReadSeeker(rs io.ReadSeeker) ([]byte, error) {
	...
	// Copy data from the ReadSeeker to the hash
