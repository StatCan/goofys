...
func createRequest(host string, method string, filePath string) *http.Request {
	s3Log.Debug("Inside createRequest")
	...
	payload := strings.NewReader("") // just keeping as this as generated by postman
	...
	signature := generateSignature(timeStampISO8601Format, timestampYMD, hashedPayload, host, filePath)
...
func (s *S3Backend) GetBlob(param *GetBlobInput) (*GetBlobOutput, error) {
	...
	filePath = "/1121045215484495542%2Fregular"
